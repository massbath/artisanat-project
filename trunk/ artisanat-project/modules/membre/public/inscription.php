...
<fieldset><legend> Votre E-Mail (**)</legend>
...
<fieldset><legend> Confirmation de votre E-Mail (**)</legend>
	<p><input name="mail_bis" type="text" value="<?php if(isset($_SESSION['enr_mail_bis'])){ echo $_SESSION['enr_mail_bis']; unset($_SESSION['enr_mail_bis']);} ?>"></p></fieldset>
<fieldset><legend> Votre Adresse (*)</legend>
	<p><input name="adresse" type="text" value="<?php if(isset($_SESSION['enr_adresse'])){ echo $_SESSION['enr_adresse']; unset($_SESSION['enr_adresse']);} ?>"></p></fieldset>
<fieldset><legend> Votre Code Postal (*)</legend>
	<p><input name="cp" type="text" value="<?php if(isset($_SESSION['enr_cp'])){ echo $_SESSION['enr_cp']; unset($_SESSION['enr_cp']);} ?>"></p></fieldset>
<fieldset><legend> Votre Ville (*)</legend>
	<p><input name="ville" type="text" value="<?php if(isset($_SESSION['enr_ville'])){ echo $_SESSION['enr_ville']; unset($_SESSION['enr_ville']);} ?>"></p></fieldset>
<fieldset><legend> Votre Téléphone Fixe</legend>
	<p><input name="telf" type="text" value="<?php if(isset($_SESSION['enr_telf'])){ echo $_SESSION['enr_telf']; unset($_SESSION['enr_telf']);} ?>"></p></fieldset>
<fieldset><legend> Votre Téléphone Mobile</legend>
	<p><input name="telm" type="text" value="<?php if(isset($_SESSION['enr_telm'])){ echo $_SESSION['enr_telm']; unset($_SESSION['enr_telm']);} ?>"></p></fieldset>
