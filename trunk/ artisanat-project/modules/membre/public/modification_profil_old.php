				...
				<script language="JavaScript">			
					function valider() {	
						if(validateName() && validateFirstname() && 
						   ...
						   validateCaptcha() && validateEmailFree()) {
					...
					function validateCaptcha() {
						var a = document.formulaireModificationProfil.useless.value;
						
						var b = document.formulaireModificationProfil.captchaCode.value;
